...
public:
    void displayMessage()
    {
        ...
        cout << "----------------------------Copyright.Abubakar Atiq.https://www.github.com/AbubakarAtiq-----------------------------" << endl;
    }
};
class reason
{
...
{
public:
    void AuthorQuestionMark()
    {
        cout << "1. GitHub: https://www.github.com/AbubakarAtiq" << endl;
        cout << "2. Facebook: https://www.facebook.com/mohammadabubakaratiq" << endl;
        cout << "3. Twitter: https://www.twitter.com/BakarAtiq" << endl;
        cout << "4. Github repository link: https://github.com/AbubakarAtiq/covid-in-cpp" << endl;
    }
    void displayMessage2()
    {
        ...
        string symbol;
        cout << "Will you like to see more detailes related to the program?:Type(?)";
        getline(cin, symbol);
...
public:
    void displayMessage3()
    {
        ...
        else if ((user_say_yesorno != "Y") || (user_say_yesorno != "YES") || (user_say_yesorno != "yes") || (user_say_yesorno != "y"))
        {
            cout << "Invalid input, again," << endl;
            displayMessage3();
        }
        else if ((user_say_yesorno != "N") || (user_say_yesorno != "NO") || (user_say_yesorno != "y") || (user_say_yesorno != "yes"))
        {
            cout << "Invalid input,again," << endl;
            displayMessage3();
        }
...
public:
    void displayMessage4()
    {
        ...
        else if ((user_say_yesorno != "Y") || (user_say_yesorno != "y") || (user_say_yesorno != "YES") || (user_say_yesorno != "yes"))
        {
            cout << "Entered wrong input, again" << endl;
            displayMessage4();
        }
        else if ((user_say_yesorno != "N") || (user_say_yesorno != "NO") || (user_say_yesorno != "n") || (user_say_yesorno != "no"))
        {
            cout << "Entered wrong input, again" << endl;
            displayMessage4();
        }
...
public:
    void displayMessage5()
    {
        ...
        else if ((user_say_yesorno != "Y") || (user_say_yesorno != "YES") || (user_say_yesorno != "y") || (user_say_yesorno != "yes"))
        {
            cout << "Invalid input, again," << endl;
            displayMessage5();
        }
